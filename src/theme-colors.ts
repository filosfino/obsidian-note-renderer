...
export const BUILT_IN_THEME_COLOR_TOKENS = {
  ...
  cream: {
    ...
    blockquoteText: "#5c544d",
    blockquoteBorder: "#e07c5a",
    inlineCodeText: "#9f3f3f",
  ...
  latte: {
    ...
    blockquoteText: "#625248",
    blockquoteBorder: "#a17453",
    inlineCodeText: "#7f4343",
  ...
  mist: {
    ...
    blockquoteText: "#556170",
    blockquoteBorder: "#8696a7",
    inlineCodeText: "#645776",
  ...
  paper: {
    ...
    bodyText: "#1a1a1a",
    title: "#1a1a1a",
    highlight: "rgba(230,201,120,0.42)",
    blockquoteText: "#555",
    blockquoteBorder: "#e0e0e0",
    inlineCodeText: "#b43f3f",
  ...
  rose: {
    ...
    blockquoteText: "#76585a",
    blockquoteBorder: "#965454",
    inlineCodeText: "#7a4f4f",
  ...
  sage: {
    ...
    blockquoteText: "#58684f",
    blockquoteBorder: "#7b8b6f",
    inlineCodeText: "#55674c",
